                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                    <tr>
                                        ...
                                        <td><a href="frmeditadmin.php?id=<?php echo $row["id"]; ?>"
                                                class="btn btn-warning">ແກ້ໄຂ</a></td>
                                        <td><a href="deleteadmin.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger"
                                                onclick="return confirm('ຕ້ອງການລົບຂໍໍ້ມູນຫຼືບໍ່')">ລົບຂໍ້ມູນ</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
